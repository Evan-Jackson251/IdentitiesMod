package com.schnozz.identitiesmod.events.power_events.adaptation;
...
public class ClientAdaptationEvents {
    //base: (543,480)
    //guiScaledScreen: (427,240)
    //screen: (854,480)
    //bottom y: 272+19
    private static CooldownIcon switchIcon = new CooldownIcon(0,0,19, ResourceLocation.fromNamespaceAndPath(IdentitiesMod.MODID, "textures/gui/adaptation_icon.png"));
    ...
    public static void onClientTick(ClientTickEvent.Post event) {
        ...
        System.out.println("X: " + CooldownUtil.getCooldownX(0));
        System.out.println("Y: " + CooldownUtil.getCooldownY());
